    ...
    def get_patches(self, version):
        ...
        if is_v136_plus:
            return [
                ...
                ("Patch 2 (GpuMain Initialization Bypass)",
                 bytes.fromhex("84 c0 0f 85 c9 02 00 00 48 c7 85 a8 fd ff ff 43"),
                 bytes.fromhex("84 c0 e9 ca 02 00 00 90 48 c7 85 a8 fd ff ff 43")),
